<script lang="ts">
  ...
  import ArrowDownNarrowWide from '~icons/lucide/arrow-down-narrow-wide';
  ...
  import Disc3 from '~icons/lucide/disc-3';
...
<IconComponent
  width={size}
  height={size}
  stroke-width={name === 'spotify' ? undefined : strokeWidth}
  aria-hidden="true"
/>
